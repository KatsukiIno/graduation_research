...
input_image_directory = "input/images/pose"  # 画像ファイルが保存されているディレクトリのパス
output_csv_path = 'model/pose_classifier/sample_24_11_12.csv'
output_image_path = 'output/images/pose'
pose_label = 1
        ...
        for filename in os.listdir(input_image_directory):
            if filename.endswith(".jpg") or filename.endswith(".png"):
                ...
                if results.pose_landmarks is not None:
                  ...
                  # logging_csv(pre_processed_pose_landmark, filename)
