...
input_video_path = "input/videos/action_videos/auto_score_video.mp4"
  ...
  with mp_holistic.Holistic(min_detection_confidence=0.3,
    ...
    while cap.isOpened():
      ...
      if results.pose_landmarks is not None:
        ...
        # ///////////////////////////////////////////////////////
        class_label, queue = update_class_queue(0, np.argmax(pose_probs), 7)
      ...
      if pose_history:
        ...
        if pose_history[-1] in [6, 8]:
          if results.right_hand_landmarks is not None:
            ...
            right_hand_class_label, queue = update_class_queue(1, np.argmax(right_probs), 7)
            if right_hand_class_label is not None:
              if prov_right_hand_class_label != right_hand_class_label:
                ...
                print(f"right_hand_queue:{queue}")
        ...
        if pose_history[-1] in [7, 8]:
          # print("7 or 8ありました")
          # print(f"right_hand_pose:{pose_history}")
