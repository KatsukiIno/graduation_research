...
input_video_path = r"D:lecture\videos\input\videos\action_videos\auto_score_video.mp4"# output_csv_path = 'model/hand_classifier/mp_hands_test.csv'
      ...
      if pose_results.pose_landmarks is not None:
        ...
        if class_label is not None:
          if prov_class_label != class_label:
            if prov_class_label == 11:  # 直前のクラスラベルが11なら
            ...
            if len(pose_history) != 1 and class_label == 11:
