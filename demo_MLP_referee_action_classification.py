...
input_video_path = r"D:lecture\videos\input\videos\referee_action_videos\demo.MOV"
...
def main():
  ...
  # 縦横比を維持してリサイズ
  scale_w = original_width * 0.5
  scale_h = original_height * 0.5

  # 新しい幅と高さを計算
  new_width = int(scale_w)
  new_height = int(scale_h)
  # ///////////////////////////////////////////////////////////////////
  ...
  mp_hands.Hands(max_num_hands=2,
    ...
    while cap.isOpened():
      ...
      pose_class_display = np.ones((600, 400, 3), dtype=np.uint8) * 255  # 白背景の画像
        ...
        if hands_results.multi_hand_landmarks is not None:
          for hand_landmarks, handedness in zip(hands_results.multi_hand_landmarks, hands_results.multi_handedness):
            ...
            if pose_history[-1] in [6, 8]:
              ...
              # right_hand_class_label, _ = update_class_queue(1, np.argmax(right_probs), 7)
      ...
      if most_common_class_right_hand is not None or most_common_class_left_hand is not None:
      ...
      if pose_results.pose_landmarks is not None:
        ...
        # ///////////////////////////////////////////////////////
        class_label, _ = update_class_queue(0, np.argmax(pose_probs), 7)
        if class_label is not None:
          if prov_class_label != class_label:
            ...
            serve_allowed = get_combination_label(pose_history)
            if serve_allowed:
              pose_history.clear()
...
def get_pose_label(class_index):
  label_dict = {
    ...
    5:"right arm folding",
    6:"left hand raising",
    7:"right hand raising",
    8:"both hands raising",
    9:"end of set",
    10:"substitutions",
    11:"no pose"
    }
